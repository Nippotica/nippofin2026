...
{% include figure.liquid path="assets/images/gen/blog/tcpic.png" title="Floating Point Representations" caption="The challenges is how to switch between these without compromising numerical performance." class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid path="assets/images/gen/blog/tcworkflow.webp" title="The Transprecision Workflow" caption="Nippotica's Transprecision In Practice." class="img-fluid rounded z-depth-1" %}
