...
{% include figure.liquid path="/assets/images/gen/content/koumodelfull.png" title="" caption="The Kou diffusion model is a great way to simulate realistic-looking asset prices" class="img-fluid rounded z-depth-1" %}
