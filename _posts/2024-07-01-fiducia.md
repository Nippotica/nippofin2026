...
date: 2024-07-01
categories: ["Technote"]
tags: machine-learning insurance
...
This means that Fiducia is a specialized model created to answer specific queries based on set guidelines and rules of your company. 
...
{% include figure.liquid path="/assets/images/gen/content/llmfiducia.webp" title="" caption="Tech enablers of an LLM" class="img-fluid rounded z-depth-1" %}
